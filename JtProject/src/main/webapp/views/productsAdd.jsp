...
<%--&lt;%&ndash;						<label for="name">Id</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;						<input type="number" readonly="readonly" class="form-control border border-warning" name="id"  value="${product.id + 1} ">&ndash;%&gt;--%>
...
<%--					</div>--%>
					...
					<div class="form-group">
						<img src="Product Images/one.jpg" alt="No image provided" id="imgPreview" height="100px" width="100px"
